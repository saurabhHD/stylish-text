...
function generateFancy(txt) {
 ...
 $(".loadmore").click(function(){
   ...
   for(var i=1;i<=10;i++){
    fancyText  =  '<div class="input-group mb-3 ok"><input type="text" class="form-control cp-text text-size" value="'+crazyWithFlourishOrSymbols(text)+'" id="copy_'+ct+'" readonly="readonly"><div class="input-group-append"><span class="input-group-text copybutton" style="cursor:pointer;" data-clipboard-action="copy" data-clipboard-target="#copy_'+ct+'"><i class="fa fa-copy text-secondary fa-2x"></i></span></div></div>';
      ct++;
